...
public class Menu {
    ...
    public static void menu() {
        ...
        do {
            ...
            switch (opcion) {
                case 1 -> Consultas.printearConsultas(Consultas.consulta1(mongoC));
                case 2 -> Consultas.printearConsultas(Consultas.consulta2(mongoC));
                case 3 -> Consultas.printearConsultas(Consultas.consulta3(mongoC));
                case 4 -> Consultas.printearConsultas(Consultas.consulta4(mongoC));
                case 5 -> Consultas.printearConsultas(Consultas.consulta5(mongoC));
                case 6 -> Consultas.printearConsultas(Consultas.consulta6(mongoC));
                case 7 -> Consultas.printearConsultas(Consultas.consulta7(mongoC));
                case 8 -> Consultas.printearConsultas(Consultas.consulta8(mongoC));
                case 9 -> Consultas.printearConsultas(Consultas.consulta9(mongoC));
                case 10 -> Consultas.printearConsultas(Consultas.consulta10(mongoC));
                case 11 -> Consultas.printearConsultas(Consultas.consulta11(mongoC));
                case 12 -> Consultas.printearConsultas(Consultas.consulta12(mongoC));
